...
import React, { useEffect, useState } from 'react';
import logo from '/src/assets/awasabi_logo.jpg'
import { 
  LayoutGrid, 
  BookOpen, 
  MessageSquare, 
    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center gap-3 mb-12 mt-8 md:mt-0">
          <div className="w-20 h-20   flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-green-900/20">
            <img 
                              src={logo} 
                              alt="AwaSabi Logo" 
                              className="w-20 h-20 rounded-full shadow-lg shadow-green-600/20 object-cover border-2 border-green-600"
                            />
          </div>
